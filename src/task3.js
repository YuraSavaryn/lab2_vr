...
function onSelect() {        
    if (reticle.visible) {
        // 1. Створюємо геометрію згідно з вашим варіантом
        // Параметри: (радіус, деталізація)
        const geometry = new THREE.DodecahedronGeometry(0.1, 0); 
        
        // 2. Створюємо матеріал (можна залишити рандомним для ефектності)
        ...
        // 3. Встановлюємо позицію та орієнтацію об'єкта відповідно до мітки (reticle)
        mesh.position.setFromMatrixPosition(reticle.matrix);
        mesh.quaternion.setFromRotationMatrix(reticle.matrix);
        
        // Додаємо невелике зміщення по висоті, щоб об'єкт стояв "на" поверхні, а не в ній
